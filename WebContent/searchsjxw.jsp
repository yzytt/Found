   ...
   <!-- //banner -->
    ...
    <section class="content-info py-5">
        <div class="container py-md-5">
            <h3 class="title-w3ls mb-5 text-center">输入时间之前的寻物启事</h3>
            <div class="row">
      <%
      rs=dao.listAllds();
                                            	      if(rs==null){
                                            	    	  ...
                                            	    	  while(rs.next()&&rs.getString("time").compareTo(time)<0){%>
                                            				<!-- mian-content -->
                         ...
                         <p class="mt-2">发布人<%=rs.getString("userName") %></p>
                                            	                         <div class="read-icon">
                                            	                             <a href="single.jsp?id=<%=rs.getString("id") %>" class="btn read">More Info</a>
                                            	                         </div>
                                            	                     </div>
                                            	                 </div>
                                            	             </div> 
