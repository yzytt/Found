...
<div id="header">
	<div class="shell">
		...
		<div id="navigation">
			<ul>
			    <li><a href="main_right.jsp" class="active"><span>我发表的失物表单</span></a></li>
			    <li><a href="main_right1.jsp"><span>我发表的招领表单</span></a></li>
...
<%        int id = Integer.parseInt(request.getParameter("id"));
		ResultSet rs=dao.listdsByid(id);
		if(rs==null){ 
    	  %>
		...
		if(rs.next()){%>
				...
				<div class="box">
					...
					<form action="addServlet?method=main_right_updateds" method="post">
