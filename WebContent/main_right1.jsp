...
<div id="header">
	<div class="shell">
		...
		<div id="navigation">
			<ul>
			    <li><a href="main_right.jsp" ><span>我发表寻物启事</span></a></li>
			    <li><a href="main_right1.jsp" class="active"><span>我发表的失物招领</span></a></li>
		...
		<div id="main">
			...
			<div id="content">
				...
				<div class="box">
					...
					<!-- Table -->
					<form action="addServlet?method=main_right1_deletejd" method="post">
					<div class="table">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<%
        ResultSet rs=dao.searchjdByuserName(userName);
		int dsnumber = 1;
      ...
      if(rs==null){
		...
		while(rs.next()){%>
							<tr>
								...
								<td><a onclick="return check()" href="main_right1_deletejd.jsp?id=<%=rs.getInt("id") %>" class="ico del">删除</a><a href="main_right1_updatejd.jsp?id=<%=rs.getInt("id") %>" class="ico edit">修改</a></td>
							</tr>
							<%
							dsnumber++;}
							}%>
