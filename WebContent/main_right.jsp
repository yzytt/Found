...
<div id="header">
	<div class="shell">
		...
		<div id="navigation">
			<ul>
			    <li><a href="main_right.jsp" class="active"><span>我发表的寻物启事</span></a></li>
			    <li><a href="main_right1.jsp"><span>我发表的失物招领</span></a></li>
		...
		<div id="main">
			...
			<div id="content">
				...
				<div class="box">
					...
					<!-- Table -->
					<form action="addServlet?method=main_right_deleteds" method="post">
					<div class="table">
      ...
      if(rs==null){
		...
		while(rs.next()){%>
							<tr>
								...
								<td><a onclick="return check()" href="main_right_deleteds.jsp?id=<%=rs.getInt("id") %>" class="ico del">删除</a><a href="main_right_updateds.jsp?id=<%=rs.getInt("id") %>" class="ico edit">修改</a></td>
							</tr>
							<%
							dsnumber++;}
							}%>
